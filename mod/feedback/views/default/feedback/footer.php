...
$progress_img = '<div>'.elgg_echo('feedback:submit_msg').'<div>';
            ...
            <div id="feedBackFormInputs">
                <form id="feedBackForm" action="" method="post" onsubmit="FeedBack_Send();return false;">
                    <div>
                        ...
                        <div>
                            <div style='float:left;width:34%'><input type="radio" name="mood" value="satisfied"> <?php echo elgg_echo('feedback:mood:satisfied')?></div>
                            <div style='float:left;width:33%'><input type="radio" name="mood" value="neutral" checked> <?php echo elgg_echo('feedback:mood:neutral')?></div>
                            <div style='float:left;width:33%'><input type="radio" name="mood" value="dissatisfied"> <?php echo elgg_echo('feedback:mood:dissatisfied')?></div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div>
                            <div style='float:left;width:34%'><input type="radio" name="about" value="bug_report"> <?php echo elgg_echo('feedback:about:bug_report')?></div>
                            <div style='float:left;width:33%'><input type="radio" name="about" value="suggestion" checked> <?php echo elgg_echo('feedback:about:suggestion')?></div>
                            <div style='float:left;width:33%'><input type="radio" name="about" value="compliment"> <?php echo elgg_echo('feedback:about:compliment')?></div><br>
                            <div style='float:left;width:34%'><input type="radio" name="about" value="complaint"> <?php echo elgg_echo('feedback:about:complaint')?></div>
                            <div style='float:left;width:33%'><input type="radio" name="about" value="other"> <?php echo elgg_echo('feedback:about:other')?></div>
                        </div>
                    </div>
                    <div style="clear:both;"></div>
