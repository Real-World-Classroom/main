...
$content .= elgg_echo('
	...
	<div style="position:absolute;bottom:0;width:90%;padding: 0 0 10px 35px;">
		<a class="elgg-button elgg-button-submit" href="' . "$site_url" . 'walkthrough/friends" style="float:left;margin:10px;font-size:20px;">
			Back
		</a>
		<a class="elgg-button elgg-button-submit" href="' . "$site_url" . 'walkthrough/settings" style="float:right;margin:10px;font-size:20px;">
			Next
		</a>
	</div>');
