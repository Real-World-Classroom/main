<?php
/**
 * This whole thing basically just puts all the main ELGG stuff at the top of the page
 * and then puts whatever's in the RWC_welcome_page_editor layout below that.
 *
 */
...
$body = elgg_view_layout('RWC_welcome_page_editor', $params);
