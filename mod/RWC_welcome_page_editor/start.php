...
// Initialize plugin
elgg_register_event_handler('init', 'system', 'RWC_welcome_page_editor_init');

function RWC_welcome_page_editor_init() {

	// Extend system CSS with our own styles
	elgg_extend_view('css/elgg', 'RWC_welcome_page_editor/css');
